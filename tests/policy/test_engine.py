...
def test_default_policy_version_matches_canonical_fixture() -> None:
    assert engine().policy_version == (
        "devpi-guardian-policy/1+sha256:"
        "0834262299b22f6dedb3f585173468595b8406f54a9ae207ed1eb5c56ba10e77"
    )
